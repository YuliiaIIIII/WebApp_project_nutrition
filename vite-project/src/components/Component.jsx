function Component({ receipt, func }) { 
  ...
  return (
    <div
      // key={receipt.id}
      id="userRequest"
      className="h-64	shadow-lg bg-orange-50 w-10/12 block mx-0 rounded-xl outline outline-offset-1 outline-indigo-200 md:flex md:flex-row lg:w-11/12 xlg:w-11/12 xlg:flex-col xlg:w-4/5"
