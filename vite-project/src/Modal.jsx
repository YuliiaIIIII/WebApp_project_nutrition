        ...
        <div className="flex min-h-full items-end justify-center p-6 text-center">
          <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all">
            ...
            <div className="bg-indigo-200 px-4 py-3">
              <button 
                type="button" 
                className="mt-3 inline-flex w-full justify-center border border-1 border-indigo-600 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-300"
